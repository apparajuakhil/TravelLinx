...
const AdminHotel = () => {
    ...
    const deleteHotel = async (hotelId) => {
        try {
            const result = await axios.delete(`/users/u-1e5ad803-7877-4c8c-ac86-300dd6827dba/hotels/${hotelId}`);
    ...
    useEffect(async () => {
      let result = await axios.get(`/users/u-1e5ad803-7877-4c8c-ac86-300dd6827dba/hotels/`);
