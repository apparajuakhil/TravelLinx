...
function AdminEditRoom() {
    ...
    useEffect(async () => {
      ...
      let result = await axios.get(`/users/u-1e5ad803-7877-4c8c-ac86-300dd6827dba/hotels/${hotelId}/rooms/${roomId}`);
    ...
    const updateRoom = async () => {
        try {
            ...
            const result = await axios.put(`/users/u-1e5ad803-7877-4c8c-ac86-300dd6827dba/hotels/${hotelId}/rooms/${roomId}`, {basePrice, noOfRooms, maxNumberOfGuests, type});
